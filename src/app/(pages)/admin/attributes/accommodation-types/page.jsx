...
const AccommodationTypesPage = () => {
  const [accommodationTypes, setAccommodationTypes] = useState([
    ...
    },
    {
      ...
      name: "Tented Camp",
      slug: "tented-camp",
      description: "Safari-style canvas accommodations",
      color: "#16A34A",
      isActive: true,
      createdAt: "2024-01-01",
    },
    {
      ...
      name: "Hotel",
      slug: "hotel",
      description: "Urban accommodations with full services",
      color: "#2563EB",
      isActive: true,
      createdAt: "2024-01-01",
    },
    {
      ...
      name: "Camping",
      slug: "camping",
      description: "Basic outdoor accommodation options",
      color: "#059669",
      isActive: true,
      createdAt: "2024-01-01",
    },
  ...
  const handleDelete = (type) => {
    if (confirm("Are you sure you want to delete this accommodation type?")) {
      setAccommodationTypes(accommodationTypes.filter((t) => t.id !== type.id));
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal
        ...
        title={
          editingType ? "Edit Accommodation Type" : "Add Accommodation Type"
        }
        size="md"
      >
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end space-x-4">
            ...
            >
              ...
              {editingType ? "Update" : "Create"} Accommodation Type
            </button>
          </div>
        </form>
      </Modal>
