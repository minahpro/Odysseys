...
const TourCategoriesPage = () => {
  const [tourCategories, setTourCategories] = useState([
    {
      ...
      description: "Tours focusing on the Big Five animals",
      color: "#DC2626",
      isActive: true,
      tourCount: 8,
    ...
    },
    {
      ...
      description: "Witness the annual wildebeest migration",
      color: "#059669",
      isActive: true,
      tourCount: 5,
      createdAt: "2024-01-01",
    },
    {
      ...
      description: "Kilimanjaro and other mountain adventures",
      color: "#374151",
      isActive: true,
      tourCount: 12,
      createdAt: "2024-01-01",
    },
    {
      ...
      name: "Beach & Islands",
      slug: "beach-islands",
      description: "Zanzibar and coastal experiences",
      color: "#0EA5E9",
      isActive: true,
      tourCount: 6,
      createdAt: "2024-01-01",
  ...
  const handleDelete = (category) => {
    if (confirm("Are you sure you want to delete this tour category?")) {
      setTourCategories(tourCategories.filter((c) => c.id !== category.id));
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal
        ...
        title={editingCategory ? "Edit Tour Category" : "Add Tour Category"}
        size="md"
      >
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end space-x-4">
            ...
            >
              ...
              {editingCategory ? "Update" : "Create"} Tour Category
            </button>
          </div>
        </form>
      </Modal>
