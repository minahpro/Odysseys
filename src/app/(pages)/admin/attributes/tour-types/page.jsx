...
const TourTypesPage = () => {
  const [tourTypes, setTourTypes] = useState([
    {
      ...
      name: "Safari",
      slug: "safari",
      description: "Wildlife viewing adventures in national parks",
      color: "#10B981",
      isActive: true,
    ...
    },
    {
      ...
      name: "Trekking",
      slug: "trekking",
      description: "Mountain climbing and hiking adventures",
      color: "#F59E0B",
      isActive: true,
      createdAt: "2024-01-01",
    },
    {
      ...
      name: "Cultural",
      slug: "cultural",
      description: "Cultural immersion and local community visits",
      color: "#8B5CF6",
      isActive: true,
      createdAt: "2024-01-01",
    },
    {
      ...
      name: "Beach",
      slug: "beach",
      description: "Coastal and island experiences",
      color: "#06B6D4",
      isActive: false,
      createdAt: "2024-01-01",
    },
  ...
  const handleDelete = (type) => {
    if (confirm("Are you sure you want to delete this tour type?")) {
      setTourTypes(tourTypes.filter((t) => t.id !== type.id));
    }
  };
  ...
  return (
    <div className="space-y-6">
      ...
      <Modal
        ...
        title={editingType ? "Edit Tour Type" : "Add Tour Type"}
        size="md"
      >
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex justify-end space-x-4">
            ...
            >
              ...
              {editingType ? "Update" : "Create"} Tour Type
            </button>
          </div>
        </form>
      </Modal>
